...
MY_EXPORT void QAdvancedTimer::setup()
{
...
MY_EXPORT void QAdvancedTimer::waitm(quint32 m_Interval)
{
    usleep(m_Interval * 1000);
}

MY_EXPORT void QAdvancedTimer::waitu(quint32 m_Interval)
{
    usleep(m_Interval);
}

MY_EXPORT void QAdvancedTimer::waitn(quint32 m_Interval)
{
